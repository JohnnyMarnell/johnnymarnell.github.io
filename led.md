...
{% include video id="uXDbkIkoSk0" alt="Vertical LED video" %}
{% include video id="nLRTtxrm7z0" alt="Vertical LED patterns" %}
{% include video id="SzUIuTK63jA" alt="Vertical LED show" %}
